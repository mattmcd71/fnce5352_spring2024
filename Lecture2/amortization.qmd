...
Variable Rate: $$pmt = \frac{rate_{t}}{1 - (1 + rate_{t})^{-term_{t}}} * balance_{t}$$

## Day Counting Conventions {.smaller}

Day counting convention impacts the conversion of annual rate to monthly rate

30/360: $$rate_{monthly}=rate_{annual} * (\frac{30}{360}) = \frac{rate_{annual}}{12}$$

Actual/360: $$rate_{monthly}=rate_{annual} * (\frac{days\;in\;month}{360})$$

Actual/Actual: $$rate_{monthly}=rate_{annual} * (\frac{days\;in\;month}{days\;in\;year})$$